...
public abstract class CraftingMenuMixin {
    ...
    private static ItemStack lifesteal$checkIfHeartCrafted(CraftingRecipe instance, RecipeInput recipeInput, HolderLookup.Provider provider, Operation<ItemStack> original, @Local(argsOnly = true) Player player) {
